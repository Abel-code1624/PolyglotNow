...
<html>
  <head>
    ...
    <title>Rumano T1: Cuvinte Simple</title>
...
<div id="pregunta-container" class="pri">
  <form id="formulario">
  <h1 id="titulo">Cuvinte Simple</h1>
  <div id="pregunta"></div>
  <div id="respuestas">
...
const preguntas = [
  ...
  {
    "pregunta": "¿Qué significa 'Casă mare'?",
    "respuestas": ["Mansión grande", "Casa grande", "Apartament pequeño", "Casa enorme"],
    "correcta": "Casa grande"
  },
  {
    "pregunta": "¿Qué significa 'Măr verde'?",
    "respuestas": ["Manzana roja", "Pera verde", "Manzana verde", "Manzana gris"],
    "correcta": "Manzana verde"
  },
  {
    "pregunta": "¿Qué significa 'Scaunul școlii'?",
    "respuestas": ["Silla de la escuela", "La revedere", "Încântat de cunoștință", "Scuze"],
    "correcta": "Silla de la escuela"
  },
  {
    "pregunta": "Am o mașină roșie",
  ...
  {
    "pregunta": "Ea scrie cu un stilou albastru",
