...
<html>
  <head>
    ...
    <title>Francés T3: Adjectifs et Adverbes</title>
...
const preguntas = [
  {
    pregunta: "¿Cómo se dice 'rápido' en francés?",
    respuestas: ["Lent","Rapide","Vite","Tard"],
    correcta: "Rapide"
  },
  {
    pregunta: "¿Cómo se dice 'lentamente' en francés?",
    respuestas: ["Rapidement","Doucement","Lentement","Vite"],
    correcta: "Lentement"
  },
  {
    pregunta: "¿Cómo se dice 'feliz' en francés?",
    respuestas: ["Triste","Heureux","Fatigué","Grand"],
    correcta: "Heureux"
  },
  {
    pregunta: "¿Cómo se dice 'triste' en francés?",
    respuestas: ["Content","Triste","Heureux","Petit"],
    correcta: "Triste"
  },
  {
    pregunta: "¿Cómo se dice 'alto' en francés?",
    respuestas: ["Bas","Grand","Petit","Court"],
    correcta: "Grand"
  },
  {
    pregunta: "¿Cómo se dice 'bajo' en francés?",
    respuestas: ["Bas","Haut","Long","Grand"],
    correcta: "Bas"
  },
  {
    pregunta: "¿Cómo se dice 'siempre' en francés?",
    respuestas: ["Jamais","Toujours","Souvent","Tard"],
    correcta: "Toujours"
  },
  {
    pregunta: "¿Cómo se dice 'nunca' en francés?",
    respuestas: ["Toujours","Jamais","Souvent","Hier"],
    correcta: "Jamais"
  },
  {
    pregunta: "¿Cómo se dice 'cerca' en francés?",
    respuestas: ["Loin","Près","Tard","Vite"],
    correcta: "Près"
  },
  {
    pregunta: "¿Cómo se dice 'lejos' en francés?",
    respuestas: ["Près","Loin","Bas","Bien"],
    correcta: "Loin"
  },
  {
    pregunta: "¿Cómo se dice 'temprano' en francés?",
    respuestas: ["Tard","Tôt","Hier","Vite"],
    correcta: "Tôt"
  },
  {
    pregunta: "¿Cómo se dice 'tarde' en francés?",
    respuestas: ["Tôt","Tard","Bien","Mal"],
    correcta: "Tard"
  },
  {
    pregunta: "¿Cómo se dice 'bien' en francés?",
    respuestas: ["Mal","Bien","Bon","Mauvais"],
    correcta: "Bien"
  },
  {
    pregunta: "¿Cómo se dice 'mal' en francés?",
    respuestas: ["Bien","Mal","Bon","Petit"],
    correcta: "Mal"
  },
  {
    pregunta: "¿Cómo se dice 'mucho' en francés?",
