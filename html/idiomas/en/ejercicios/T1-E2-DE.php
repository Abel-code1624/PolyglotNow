...
<html>
  <head>
    ...
    <title>German T1: Einfache Worte</title>
...
const preguntas = [
  ...
  },
  {
    ...
    "respuestas": ["Großes Haus", "Kleines Haus", "Rotes Haus", "Häuschen"],
    "correcta": "Großes Haus"
  },
  {
    "pregunta": "What does 'Green apple' mean?",
    "respuestas": ["Roter Apfel", "Grüner Apfel", "Blaue Apfel", "Gelber Apfel"],
    "correcta": "Grüner Apfel"
  },
  {
    "pregunta": "What does 'School chair' mean?",
    "respuestas": ["Stuhl der Schule", "Schulstuhl", "Blauer Stuhl", "Stuhl im Büro"],
    "correcta": "Schulstuhl"
  },
  {
    "pregunta": "I have a red car",
    "respuestas": ["Ich habe ein rotes Auto", "Ich habe ein grünes Auto", "Ich habe ein gelbes Auto", "Ich habe ein rotes Fahrrad"],
    "correcta": "Ich habe ein rotes Auto"
  },
  {
    "pregunta": "She writes with a blue pen",
    "respuestas": ["Sie schreibt mit einem blauen Stift", "Er schreibt mit einem grünen Stift", "Sie schreibt mit einem roten Stift", "Sie schreibt mit einem blauen Pinsel"],
    "correcta": "Sie schreibt mit einem blauen Stift"
  },
  {
    "pregunta": "Where is the dog?",
    "respuestas": ["Wo ist der Hund?", "Wo ist die Katze?", "Wo ist der Tisch?", "Wo ist das Auto?"],
    "correcta": "Wo ist der Hund?"
  },
  {
    "pregunta": "Do you like apples?",
    "respuestas": ["Mag er Äpfel?", "Mag er Bananen?", "Mag sie Äpfel?", "Mag er Orangen?"],
    "correcta": "Mag er Äpfel?"
  },
  {
    "pregunta": "Are we your friends?",
    "respuestas": ["Sind wir deine Freunde?", "Seid ihr meine Freunde?", "Sind wir Freunde?", "Seid ihr meine Familie?"],
    "correcta": "Sind wir deine Freunde?"
  }
];
