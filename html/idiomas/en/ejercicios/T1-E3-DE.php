...
<html>
  <head>
    ...
    <title>German T1: Adjektive und Adverbien</title>
...
<div id="pregunta-container" class="pri">
  <form id="formulario">
  <h1 id="titulo">Adjektive und Adverbien</h1>
  <div id="pregunta"></div>
  <div id="respuestas">
...
const preguntas = [
  {
    ...
    respuestas: ["Langsam","Schnell","Früh","Spät"],
    correcta: "Schnell"
  },
  {
    pregunta: "How do you say 'slowly' in German?",
    respuestas: ["Schnell","Langsam","Früh","Spät"],
    correcta: "Langsam"
  },
  {
    pregunta: "How do you say 'happy' in German?",
    respuestas: ["Traurig","Glücklich","Groß","Klein"],
    correcta: "Glücklich"
  },
  {
    pregunta: "How do you say 'sad' in German?",
    respuestas: ["Glücklich","Traurig","Früh","Spät"],
    correcta: "Traurig"
  },
  {
    pregunta: "How do you say 'tall' in German?",
    respuestas: ["Groß","Klein","Kurz","Lang"],
    correcta: "Groß"
  },
  {
    pregunta: "How do you say 'low' in German?",
    respuestas: ["Groß","Niedrig","Lang","Kurz"],
    correcta: "Niedrig"
  },
  {
    pregunta: "How do you say 'always' in German?",
    respuestas: ["Nie","Immer","Oft","Bald"],
    correcta: "Immer"
  },
  {
    pregunta: "How do you say 'never' in German?",
    respuestas: ["Immer","Nie","Oft","Jetzt"],
    correcta: "Nie"
  },
  {
    pregunta: "How do you say 'near' in German?",
    respuestas: ["Fern","Nah","Früh","Spät"],
    correcta: "Nah"
  },
  {
    pregunta: "How do you say 'far' in German?",
    respuestas: ["Nah","Fern","Jetzt","Bald"],
    correcta: "Fern"
  },
  {
    pregunta: "How do you say 'early' in German?",
    respuestas: ["Spät","Früh","Jetzt","Bald"],
    correcta: "Früh"
  },
  {
    pregunta: "How do you say 'late' in German?",
    respuestas: ["Früh","Spät","Jetzt","Nah"],
    correcta: "Spät"
  },
  {
    pregunta: "How do you say 'well' in German?",
    respuestas: ["Schlecht","Gut","Groß","Klein"],
    correcta: "Gut"
  },
  {
    pregunta: "How do you say 'badly' in German?",
    respuestas: ["Gut","Schlecht","Lang","Kurz"],
    correcta: "Schlecht"
  },
  {
    pregunta: "How do you say 'much' in German?",
    respuestas: ["Wenig","Viel","Mehr","Klein"],
    correcta: "Viel"
  }
];
