...
<html>
  <head>
    ...
    <title>Italian T1: Aggettivi e Avverbi</title>
...
const preguntas = [
  {
    pregunta: "How do you say 'fast' in Italian?",
    respuestas: ["Lento","Rapido","Presto","Tardi"],
    correcta: "Rapido"
  },
  {
    pregunta: "How do you say 'slowly' in Italian?",
    respuestas: ["Velocemente","Lentamente","Presto","Sempre"],
    correcta: "Lentamente"
  },
  {
    pregunta: "How do you say 'happy' in Italian?",
    respuestas: ["Triste","Felice","Stanco","Grande"],
    correcta: "Felice"
  },
  {
  pregunta: "How do you say 'sad' in Italian?",
  respuestas: ["Felice","Triste","Alto","Basso"],
  correcta: "Triste"
  },
  {
    pregunta: "How do you say 'tall' in Italian?",
    respuestas: ["Basso","Alto","Grande","Piccolo"],
    correcta: "Alto"
  },
  {
    pregunta: "How do you say 'low' in Italian?",
    respuestas: ["Alto","Basso","Grande","Corto"],
    correcta: "Basso"
  },
  {
    pregunta: "How do you say 'always' in Italian?",
    respuestas: ["Mai","Sempre","Spesso","Presto"],
    correcta: "Sempre"
  },
  {
    pregunta: "How do you say 'never' in Italian?",
    respuestas: ["Sempre","Mai","Spesso","Ora"],
    correcta: "Mai"
  },
  {
    pregunta: "How do you say 'near' in Italian?",
    respuestas: ["Vicino","Lontano","Presto","Tardi"],
    correcta: "Vicino"
  },
  {
    pregunta: "How do you say 'far' in Italian?",
    respuestas: ["Vicino","Lontano","Sempre","Ora"],
    correcta: "Lontano"
  },
  {
  pregunta: "How do you say 'early' in Italian?",
  respuestas: ["Presto","Tardi","Sempre","Mai"],
  correcta: "Presto"
  },
  {
    pregunta: "How do you say 'late' in Italian?",
    respuestas: ["Presto","Tardi","Ora","Sempre"],
    correcta: "Tardi"
  },
  {
    pregunta: "How do you say 'well' in Italian?",
    respuestas: ["Male","Bene","Buono","Grande"],
    correcta: "Bene"
  },
  {
    pregunta: "How do you say 'badly' in Italian?",
    respuestas: ["Bene","Male","Buono","Piccolo"],
    correcta: "Male"
  },
  {
    pregunta: "How do you say 'much' in Italian?",
